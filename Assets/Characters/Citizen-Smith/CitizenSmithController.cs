        ...
        if (other.CompareTag("Player") && !other.isTrigger && !playerConversationHistory.metSmith)
        {
            ...
            conversationManager.StartConversation(
                ...
                new string[] {
                    ...
                    "You used to work a 9 to 5 in the big city as a paper pushing office drone. ",
                    "You came here to find a simpler life.",
                    "I think you found it, doing odd jobs around town, helping people out.",
                    "You were planning a camping trip a few weeks back.",
                    "The gas station attendant said he saw you heading out to the camp grounds."
                },
                90
            );
        }
